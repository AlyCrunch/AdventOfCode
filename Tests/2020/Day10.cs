...
namespace Tests._2020
{
    public class Day10
    {
        ...
        {
            int solution = Days.AdapterArray.GetJoltDifferences(Days.Helpers.ReadFileAsInteger("Inputs\\2020\\10.txt"));
        ...
        {
            var input = Days.Helpers.ReadFileAsInteger("Inputs\\2020\\10.txt");
