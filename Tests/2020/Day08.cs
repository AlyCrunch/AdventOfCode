...
namespace Tests._2020
{
    public class Day08
    {
        ...
        {
            int acc = Days.HandheldHalting.GetAccumulator(Days.Helpers.ReadFile("inputs\\2020\\08.txt"));
        ...
        {
            int acc = Days.HandheldHalting.GetAccumulatorUncorrupted(Days.Helpers.ReadFile("inputs\\2020\\08.txt"));
