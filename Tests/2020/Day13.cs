...
namespace Tests._2020
{
    public class Day13
    {
        ...
        {
            var sol = Days.ShuttleSearch.GetWaitingMinute(Days.Helpers.ReadFile("Inputs\\2020\\13.txt"));
        ...
        {
            var sol = Days.ShuttleSearch.GetTimeStampingChinese(Days.Helpers.ReadFile("Inputs\\2020\\13.txt")[1]);
