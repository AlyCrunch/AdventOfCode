...
namespace Tests._2020
{
    public class Day14
    {
        ...
        {
            var value = Days.DockingData.Decoder1(Days.Helpers.ReadFile("Inputs\\2020\\14.txt"));
        ...
        {
            var value = Days.DockingData.Decoder2(Days.Helpers.ReadFile("Inputs\\2020\\14.txt"));
