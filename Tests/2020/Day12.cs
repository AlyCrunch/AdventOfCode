...
namespace Tests._2020
{
    public class Day12
    {
        ...
        {
            int distance = Days.RainRisk.GetManhattanDistance(Days.Helpers.ReadFile("Inputs\\2020\\12.txt"));
        ...
        {
            int distance = Days.RainRisk.GetManhattanDistanceNew(Days.Helpers.ReadFile("Inputs\\2020\\12.txt"));
